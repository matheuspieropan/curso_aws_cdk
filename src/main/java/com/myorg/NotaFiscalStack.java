...
public class NotaFiscalStack extends Stack {

    private final Bucket bucket;
    private final Queue s3InvoiceQueue;

    public NotaFiscalStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public NotaFiscalStack(final Construct scope, final String id, final StackProps props) {
